            ...
            <div class="px-6 py-4">
                ...
                <div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="no_telp_222305" id="no_telp_222305" value="{{ old('no_telp_222305', $user->no_telp_222305) }}" 
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md
                    ...
                    <div>
                        ...
                        <select name="role_222305" id="role_222305" 
                            ...
                            <option value="user" {{ old('role_222305', $user->role_222305) == 'user' ? 'selected' : '' }}>User</option>
                        </select>
                        @error('role_222305')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
